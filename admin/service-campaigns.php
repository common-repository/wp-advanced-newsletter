...
if($email_service == 'Active Campaign')
{
	...
	else 
	{
		...
		<?php
		if(isset($campaign_lists) && !empty($campaign_lists) && is_array($campaign_lists))
		{
				...
				if(isset($campaign_detail['id']))
				{
					...
					<tr>
						...
						<td class="manage-column">
							<a href="?page=advanced_newsletter_mail&tab=service-campaigns&campaign_id=<?php echo $campaign_detail['id'];?>" class="button button-primary"><?php _e("View",'wp-advanced-newsletter');?></a>
				...
				foreach($all_campaign as $campaign)
				{
					...
					?>
						<tr>
							...
							<td class="manage-column">
								<a href="?page=advanced_newsletter_mail&tab=service-campaigns&campaign_id=<?php echo $campaign['id'];?>" class="button button-primary"><?php _e("View",'wp-advanced-newsletter');?></a>
